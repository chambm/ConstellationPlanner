// Copied from RealAntennas/src/RealAntennasProject/MathUtils.cs.
// Divergences vs upstream:
//   - using Unity.Mathematics; / using UnityEngine; removed.
//   - double3 and float3 aliased to Vec3d (file-level using alias).
//   - Class made public (was internal-by-default).

using System;
using double3 = ConstellationPlanner.Core.Vec3d;
using float3  = ConstellationPlanner.Core.Vec3d;
